...
const pages = [
  {
    ...
    description: '연말정산·법인세·종합소득세 계산을 카드형 단계로 입력해 빠르게 추정합니다. 핵심 용어/계산식 요약과 PDF 업로드(가능 범위)를 제공합니다.',
  },
  {
    path: '/yearend-tax',
    title: '연말정산 계산기 | 환급/추납 추정 | Tax Unified',
    description: '총급여·소득공제·세액공제 용어와 계산 흐름(과세표준→산출세액→결정세액)을 바탕으로 연말정산 환급/추납을 추정합니다. PDF 업로드(가능 범위)를 지원합니다.',
    faq: [
      {
        q: 'PDF로 자동 입력이 가능한가요?',
  ...
  },
  {
    ...
    description: '손익·세무조정(가산/차감)·결손금·최저한세·기납부·세액공제 등 핵심 용어/계산식을 바탕으로 법인세를 시뮬레이션합니다. 재무제표/신고서 PDF 참고(가능 범위)를 지원합니다.',
    faq: [
      {
  ...
  },
  {
    ...
    description: '금융소득(2,000만 원 기준) 비교과세(종합 A vs 분리 B), Gross-up, 누진세율, 기납부세액을 반영해 종합소득세를 비교 계산합니다.',
    faq: [
      {
